...
export function AppShell({
  ...
  return (
    <div className="desktop-shell mx-auto flex min-h-dvh max-w-journey flex-col px-4 pb-36 pt-4 sm:px-6">
      ...
      {footer && (
        <div className="fixed inset-x-0 bottom-0 z-50 border-t border-bee-border bg-gradient-to-t from-canvas via-canvas to-canvas/80 px-4 pb-[max(1rem,env(safe-area-inset-bottom))] pt-3 sm:mx-auto sm:max-w-journey">
          {footer}
        </div>
      )}
    </div>
