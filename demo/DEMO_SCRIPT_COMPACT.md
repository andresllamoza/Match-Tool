...
## 3:25–3:40 — Outro
- Scroll so summary + top of table + Download CSV button visible
- Hold 3 seconds, end

**Rules:** No dead air, no scrolling back, no reading match detail expanders, no master attempts log.
